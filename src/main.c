...
int vmass_register_thread(SceSize args, void *argp){
	...
	do {
		res = vmassRegisterPath("host0:umass/usb_4GB.img");
...
int module_start(SceSize args, void *argp){
	...
	HookImport("SceSdstor", 0x15243ec5, 0xd989a9f6, sceUsbMassGetDevInfo);
	HookImport("SceSdstor", 0x15243ec5, 0xb80d1df8, sceUsbMassReadSector);
	HookImport("SceSdstor", 0x15243ec5, 0x081ca197, sceUsbMassWriteSector);
	HookImport("SceSdstor", 0x15243ec5, 0xf2bab182, sceUsbMassIntrHandler);
	HookImport("SceSdstor", 0x15243ec5, 0x3c821e99, SceUsbMassForDriver_3C821E99);
	HookImport("SceSdstor", 0x15243ec5, 0x7833d935, SceUsbMassForDriver_7833D935);

	// for usbhostfs
	SceUID thid = ksceKernelCreateThread("VmassRegisterThread", vmass_register_thread, 0x60, 0x4000, 0, 0, NULL);
